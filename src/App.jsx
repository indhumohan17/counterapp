...
function App() {
  ...
  return (
    <div >
      <div className='color-container ' style={{  top: '4rem', left: '34rem' }}> <h1 style={{ position: 'absolute', marginLeft: '45%',marginTop: '4rem' }}>Counter App</h1>
      ...
      <div className="card card-animate text-center shadow" style={{ width: '22rem', padding: '2rem' ,position:'relative'}}>
        ...
        <button onClick={() => handleSetCount(count + 1)} className="btn btn-primary card m-2" style={{ width: '8rem', borderRadius:'0.2rem', bottom:'1.7rem', top:'2rem' }}>Increment</button>
        <button onClick={() => handleSetCount(count - 1)} className="btn btn-dark card m-2" style={{ width: '8rem' , borderRadius:'0.2rem', left:'8.7rem', bottom:'1.7rem', }}>Decrement</button>
